...
//		d16[16], dx16[16], dy16[16], dz16[16], q2, q4, aax[16][16], bbx[16], EoneM, EoneA,
...
//	out = fopen("CylinderWOLid1_v2_compare/cylinderwolid1_output_v2_compare.txt", "wt");
//	//ToMaya = fopen("curve.mel", "wt");
//	ToMaya = fopen("CylinderWOLid1_v2_compare/cylinderwolid1_curve_v2_compare.mel", "wt");
//	realPointsCoor = fopen("CylinderWOLid1_v2_compare/cylinderwolid1realPointsCoorCal_v2_compare.txt", "wt");
//	//test = fopen("test.txt", "rt");
//	// points after projection
//	test = fopen("CylinderWOLid1_v2_compare/cylinderwolid1_LowPoly_v2_compare.txt", "rt");
//
//	// Points before projection
//	real_points = fopen("CylinderWOLid1_v2_compare/cylinderwolid1_HighPoly_v2_compare.txt", "rt");
//	fscanf(test, "%d\n", &points);
//	printf("points= %d\n", points);
...
//	mFaceWidth = 0.0;
//
//	// calculate the error betwwen original point cloud and calculated point set
//	double mean_error = 0.0;
//	double sum_error = 0.0;
//	//for (int i = 0; i < points; i++)
//	//{
//		//sum_error += sqrtf((x_coor_real[i] - x_cal[i]) * (x_coor_real[i] - x_cal[i]) +
//			//(y_coor_real[i] - y_cal[i])(y_coor_real[i] - y_cal[i]) + (z_coor_real[i] - z_cal[i]) * (z_coor_real[i] - z_cal[i]));
//	//}
//
//	delete[] Ui;
//	delete[] Vi;
