...
//	double* x_coor = new double[5000];
//	double* y_coor = new double[5000];
//	double* z_coor = new double[5000];
//	double* x_coor_real = new double[5000];
//	double* y_coor_real = new double[5000];
//	double* z_coor_real = new double[5000];
//		n=2*jb+1;
//	n = 2 * jb - 1;
//	n0 = 2 * jb;
//	q2 = 0.1;
...
//	out = fopen("CylinderWOLid1/cylinderwolid1_output.txt", "wt");
//	//ToMaya = fopen("curve.mel", "wt");
//	ToMaya = fopen("CylinderWOLid1/cylinderwolid1_curve.mel", "wt");
//	realPointsCoor = fopen("CylinderWOLid1/cylinderwolid1realPointsCoorCal.txt", "wt");
//	//test = fopen("test.txt", "rt");
//	 //points after projection
//	test = fopen("CylinderWOLid1/cylinderwolid1_LowPoly.txt", "rt");
//
//	 //Points before projection
//	real_points = fopen("CylinderWOLid1/cylinderwolid1_HighPoly.txt", "rt");
//	fscanf(test, "%d\n", &points);
//	printf("points= %d\n", points);
...
//		fscanf(test, "%le %le %le\n", &x_coor[i], &y_coor[i], &z_coor[i]);
//		printf("points[%d] is:  %le %le &le\n", i, x_coor[i], y_coor[i]);
//
...
//	double u_length = -0.0;
//	double v_length = -0.0;
//	double* Ui = new double[5000];
//	double* Vi = new double[5000];
//	double* temp = new double[5000];
//	double* x_cal = new double[5000];
//	double* y_cal = new double[5000];
//	double* z_cal = new double[5000];
//	for (int i = 0; i <= points - 1; i++)
//	{
...
//	}
//
//	/*u_length = y_coor_max - y_coor_min;
//	v_length = z_coor_max - z_coor_min;
//	for (int i = 0; i <= points -1; i++)
//	{
//		Ui[i] = (y_coor[i] - y_coor_min) / u_length;
//		Vi[i] = (z_coor[i] - z_coor_min) / v_length;
